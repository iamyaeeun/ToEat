...
public class FoodAdapter4 extends RecyclerView.Adapter<FoodAdapter4.ViewHolder> {
    ArrayList<Food> items=new ArrayList<>();

    public FoodAdapter4(ArrayList<Food> foodList){ items=foodList;}//생성자:전달한 FoodList 받아 items리스트에 대입
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.foodDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                UserAdapter4 mDbHelper=new UserAdapter4(view.getContext());

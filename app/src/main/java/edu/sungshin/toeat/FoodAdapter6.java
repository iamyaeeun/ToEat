...
public class FoodAdapter6 extends RecyclerView.Adapter<FoodAdapter6.ViewHolder> {
    ArrayList<Food> items=new ArrayList<>();

    public FoodAdapter6(ArrayList<Food> foodList){ items=foodList;}//생성자:전달한 FoodList 받아 items리스트에 대입
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.foodDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                UserAdapter6 mDbHelper=new UserAdapter6(view.getContext());

...
public class UserAdapter5 {
    private Context mContext;
    private static SQLiteDatabase mDb;
    private UserDBActivityHelper5 mDbHelper;
    private String tableName="FoodDB5";

    public UserAdapter5(Context context)   //다른 클래스에서 Activity를 Context를 활용해 호출
    {
        this.mContext = context;
        mDbHelper = new UserDBActivityHelper5(mContext);
    }

    public UserAdapter5 createDatabase() throws SQLException  //DB 생성 코드
    {
        try
        {
    ...
    public UserAdapter5 open() throws SQLException  //DB를 여는 코드
    {
        try
        {
    ...
    public void insert(String no, String foodName, String expirationDate, String amount, String market, String memo){  //Insert
        ...
        value.put("memo",memo);
        mDb.insert("FoodDB5",null,value);  //사용자 DB에 사용자값 insert
    }

    public void delete(String foodName){
        mDb=mDbHelper.getWritableDatabase();
        mDb.delete("FoodDB5","foodName=?",new String[]{String.valueOf(foodName)});  //사용자 DB에 사용자값 delete
    ...
    public void update(String foodName, String expirationDate, String amount, String market, String memo) {
        ...
        value.put("market",market);
        value.put("memo",memo);
        mDb.update("FoodDB5",value,"foodName=?",new String[]{String.valueOf(foodName)});
    }

...
public class langjango03Fragement extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup rootView=(ViewGroup) inflater.inflate(R.layout.fragment_langjango03_fragement, container, false);
        ...
        //DB
        UserAdapter3 userAdapter=new UserAdapter3(getActivity().getApplicationContext());
        ...
        FoodAdapter3 adapter=new FoodAdapter3(foodList);
            ...
            public void onClick(View view) {
                ...
                dlg.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        foodList = userAdapter.getTableData();
                        FoodAdapter3 adapter = new FoodAdapter3(foodList);//FoodAdapter에 foodList전달
                        recyclerView.setAdapter(adapter);
                    }
                });

...
public class UserAdapter2 {
    ...
    public UserAdapter2(Context context)   //다른 클래스에서 Activity를 Context를 활용해 호출
    {
        ...
        mDbHelper = new UserDBActivityHelper2(mContext);
    }

    public UserAdapter2 createDatabase() throws SQLException  //DB 생성 코드
    {
        try
        {
    ...
    public UserAdapter2 open() throws SQLException  //DB를 여는 코드
    {
        try
        {

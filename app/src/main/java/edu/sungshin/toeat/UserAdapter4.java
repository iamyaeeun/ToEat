...
public class UserAdapter4 {
    private Context mContext;
    private static SQLiteDatabase mDb;
    private UserDBActivityHelper4 mDbHelper;
    private String tableName="FoodDB4";

    public UserAdapter4(Context context)   //다른 클래스에서 Activity를 Context를 활용해 호출
    {
        this.mContext = context;
        mDbHelper = new UserDBActivityHelper4(mContext);
    }

    public UserAdapter4 createDatabase() throws SQLException  //DB 생성 코드
    {
        try
        {
    ...
    public UserAdapter4 open() throws SQLException  //DB를 여는 코드
    {
        try
        {
    ...
    public void insert(String no, String foodName, String expirationDate, String amount, String market, String memo){  //Insert
        ...
        value.put("memo",memo);
        mDb.insert("FoodDB4",null,value);  //사용자 DB에 사용자값 insert
    }

    public void delete(String foodName){
        mDb=mDbHelper.getWritableDatabase();
        mDb.delete("FoodDB4","foodName=?",new String[]{String.valueOf(foodName)});  //사용자 DB에 사용자값 delete
    ...
    public void update(String foodName, String expirationDate, String amount, String market, String memo) {
        ...
        value.put("market",market);
        value.put("memo",memo);
        mDb.update("FoodDB4",value,"foodName=?",new String[]{String.valueOf(foodName)});
    }

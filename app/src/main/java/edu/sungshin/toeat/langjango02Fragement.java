...
public class langjango02Fragement extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup rootView=(ViewGroup) inflater.inflate(R.layout.fragment_langjango02_fragement, container, false);
        ...
        //DB
        UserAdapter2 userAdapter=new UserAdapter2(getActivity().getApplicationContext());
            ...
            public void onClick(View view) {
                ...
                dlg.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        foodList = userAdapter.getTableData();
                        FoodAdapter2 adapter = new FoodAdapter2(foodList);//FoodAdapter에 foodList전달
                        recyclerView.setAdapter(adapter);
                    }
                });

...
public class FoodAdapter5 extends RecyclerView.Adapter<FoodAdapter5.ViewHolder> {
    ArrayList<Food> items=new ArrayList<>();

    public FoodAdapter5(ArrayList<Food> foodList){ items=foodList;}//생성자:전달한 FoodList 받아 items리스트에 대입
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.foodDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                UserAdapter5 mDbHelper=new UserAdapter5(view.getContext());

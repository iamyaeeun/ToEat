...
public class langjango06Fragement extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup rootView=(ViewGroup) inflater.inflate(R.layout.fragment_langjango06_fragement, container, false);
        ...
        //DB
        UserAdapter6 userAdapter=new UserAdapter6(getActivity().getApplicationContext());
        ...
        FoodAdapter6 adapter=new FoodAdapter6(foodList);
            ...
            public void onClick(View view) {
                ...
                dlg.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        foodList = userAdapter.getTableData();
                        FoodAdapter6 adapter = new FoodAdapter6(foodList);//FoodAdapter에 foodList전달
                        recyclerView.setAdapter(adapter);
                    }
                });

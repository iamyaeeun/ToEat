...
public class langjango04Fragement extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup rootView=(ViewGroup) inflater.inflate(R.layout.fragment_langjango04_fragement, container, false);
        ...
        //DB
        UserAdapter4 userAdapter=new UserAdapter4(getActivity().getApplicationContext());
        ...
        FoodAdapter4 adapter=new FoodAdapter4(foodList);
            ...
            public void onClick(View view) {
                ...
                dlg.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        foodList = userAdapter.getTableData();
                        FoodAdapter4 adapter = new FoodAdapter4(foodList);//FoodAdapter에 foodList전달
                        recyclerView.setAdapter(adapter);
                    }
                });
